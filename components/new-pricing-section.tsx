...
const pricingTiers = [
  {
    ...
    description:
      'Covers deals up to <span class="text-white font-medium">$2 million</span> — premium risk check at <span class="text-white font-medium">0.015% cost</span>.',
    useCases: [
